...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen h-full bg-indigo-200 ">
      <Header />
      <div className="h-full flex flex-col md:flex-row p-10 md:p-10 md:h-screen lg:gap-20">
        ...
        <h1 className="tracking-wide font-black text-3xl md:text-4xl lg:text-6xl text-indigo-800">Comienza con tu proceso de Autoconocimiento y Sanación</h1>
        <h2 className='font-bold text-sm sm:text-lg  md:text-xl '>Un lugar para todas aquellas personas interesadas en la salud mental, que buscan ayuda o terapia psicológica.</h2>
        <Button
        component="a"
        href={Sendmail()}
        variant="contained"
